...
<div id="invoiceViewModal" class="modal">
    <div class="modal-box modal-xl">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-success" onclick="location.href='api/pdf.php?type=DI&id='+currentViewId">📥 Download PDF</button>
        </div>
    </div>
</div>
        ...
        return `
            <tr>
                ...
                <td><div class="action-btns">
                    ...
                    <button class="btn-xs btn-xs-pdf"    onclick="location.href='api/pdf.php?type=DI&id=${inv.id}'">📥 PDF</button>
