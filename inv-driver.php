...
<div id="invoiceViewModal" class="modal">
    <div class="modal-box modal-xl">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-success" onclick="window.open('invoice-print.php?type=DI&id='+currentViewId,'_blank')">📥 Download PDF</button>
        </div>
    </div>
</div>
        ...
        return `
            <tr>
                ...
                <td><div class="action-btns">
                    ...
                    <button class="btn-xs btn-xs-pdf"    onclick="window.open('invoice-print.php?type=DI&id=${inv.id}','_blank')">📥 PDF</button>
